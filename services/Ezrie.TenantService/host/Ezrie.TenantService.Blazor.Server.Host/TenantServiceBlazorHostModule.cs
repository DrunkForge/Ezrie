...
using Ezrie.TenantService.Blazor.Server.Host.Menus;
...
[DependsOn(
    ...
    typeof(TenantServiceBlazorServerModule)
)]
    ...
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        context.Services.PreConfigure<AbpMvcDataAnnotationsLocalizationOptions>(options =>
        {
            options.AddAssemblyResource(
                ...
                typeof(TenantServiceDomainModule).Assembly,
                ...
                typeof(TenantServiceBlazorHostModule).Assembly
            );
        });
    }
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        Configure<AbpBundlingOptions>(options =>
        {
                ...
                bundle =>
                {
                    bundle.AddFiles("/blazor-global-styles.css");
                        ...
                        bundle.AddFiles("/Ezrie.TenantService.Blazor.Server.Host.styles.css");
                }
            );
        });
        ...
        context.Services.AddAuthentication()
            .AddJwtBearer(options =>
            {
                ...
                options.Audience = "TenantService";
            });
        ...
        if (hostingEnvironment.IsDevelopment())
        {
            Configure<AbpVirtualFileSystemOptions>(options =>
            {
                ...
                options.FileSets.ReplaceEmbeddedByPhysical<TenantServiceBlazorHostModule>(hostingEnvironment.ContentRootPath);
            });
        }
