...
using Ezrie.AdministrationService.Samples;
using Volo.Abp.DependencyInjection;
using Volo.Abp.IdentityModel;

namespace Ezrie.AdministrationService;

[SuppressMessage("Globalization", "CA1303:Do not pass literals as localized parameters", Justification = "Only the Developer/SME sees this.")]
public class ClientDemoService : ITransientDependency
{
	...
	private async Task TestWithHttpClientAndIdentityModelAuthenticationServiceAsync()
	{
		...
		using (var httpClient = new HttpClient())
		{
			...
			var url = new Uri(_configuration["RemoteServices:AdministrationService:BaseUrl"] +
