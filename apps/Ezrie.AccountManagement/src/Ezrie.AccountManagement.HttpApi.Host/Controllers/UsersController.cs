		...
		where TRoleClaimDto : RoleClaimDto<TKey>
{
	...
	[HttpGet]
	public async Task<ActionResult<TUsersDto>> Get(String searchText, Int32 page = 1, Int32 pageSize = 10)
	{
	...
	public async Task<IActionResult> Delete(TKey id)
	{
		if (IsDeleteForbidden(id))
			return StatusCode((Int32)System.Net.HttpStatusCode.Forbidden);
	...
	private Boolean IsDeleteForbidden(TKey id)
	{
	...
	[HttpGet("{id}/Roles")]
	public async Task<ActionResult<UserRolesApiDto<TRoleDto>>> GetUserRoles(TKey id, Int32 page = 1, Int32 pageSize = 10)
	{
	...
	[HttpGet("{id}/Claims")]
	public async Task<ActionResult<UserClaimsApiDto<TKey>>> GetUserClaims(TKey id, Int32 page = 1, Int32 pageSize = 10)
	{
	...
	public async Task<IActionResult> DeleteUserClaims([FromRoute] TKey id, Int32 claimId)
	{
	...
	public async Task<ActionResult<RoleClaimsApiDto<TKey>>> GetRoleClaims(TKey id, String claimSearchText, Int32 page = 1, Int32 pageSize = 10)
	{
	...
	public async Task<ActionResult<TUsersDto>> GetClaimUsers(String claimType, String claimValue, Int32 page = 1, Int32 pageSize = 10)
	{
	...
	public async Task<ActionResult<TUsersDto>> GetClaimUsers(String claimType, Int32 page = 1, Int32 pageSize = 10)
	{
