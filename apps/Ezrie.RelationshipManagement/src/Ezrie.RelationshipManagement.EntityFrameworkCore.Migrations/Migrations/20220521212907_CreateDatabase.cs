...
namespace Ezrie.RelationshipManagement.EntityFrameworkCore.Migrations.Migrations
{
		...
		protected override void Up(MigrationBuilder migrationBuilder)
		{
			...
			migrationBuilder.CreateTable(
				...
				columns: table => new
				{
					...
					TryCount = table.Column<Int16>(type: "smallint", nullable: false, defaultValue: (Int16)0),
					...
					IsAbandoned = table.Column<Boolean>(type: "boolean", nullable: false, defaultValue: false),
