...
public static class RelationshipManagementEfCoreEntityExtensionMappings
{
	...
	public static void Configure()
	{
		...
		OneTimeRunner.Run(() =>
		{
			 ...
			 * USE RelationshipManagementModuleExtensionConfigurator CLASS (in the Domain.Shared project)
